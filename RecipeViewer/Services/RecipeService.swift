...
final class RecipeService {
    ...
    func getAllRecipes() async throws -> [Recipe] {
        let dataTask = AF.request(baseURL).serializingDecodable(ServerResponse.self)
        debugPrint(dataTask)
        return try await dataTask.value.recipes
    }
}

// MARK: - Mock Service for testing
class RecipeMockService {
    func getMockData(completion: @escaping (Result<[Recipe], RecipeServiceError>) -> Void) {
    ...
    func getMockEmptyData(completion: @escaping (Result<[Recipe], RecipeServiceError>) -> Void) {
        // Mock JSON response string
        let jsonString = """
            {
                "recipes": []
    ...
    func getMockInvalidData(completion: @escaping (Result<[Recipe], RecipeServiceError>) -> Void) {
        // Mock JSON response string
        let jsonString = """
            {
                "recipes": [
